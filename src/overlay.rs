...
struct OverlayHandle {
    ...
    sys: &'static sys::VR_IVROverlay_FnTable,
}
...
impl Overlay {
    ...
    pub fn create_floating(&self, key: &CStr, name: &CStr) -> Result<FloatingOverlay, OverlayError> {
        let mut handle = 0;
    ...
    // Create a new floating overlay
    pub fn create_dashboard(&self, key: &str, name: &str) -> Result<DashboardOverlay, OverlayError> {
        let mut handle = 0;
        let mut thumbnail = 0;
